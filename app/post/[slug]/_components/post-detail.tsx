...
export default function PostDetail({ data }: { data: IPost }) {
  return (
    <article className="flex flex-col gap-6 pt-10">
      ...
      <div className="prose max-w-max mx-auto px-5 text-white  dark:prose-invert prose-a:text-blue-400 prose-img:rounded-lg prose-img:mx-auto prose-img:my-5">
        {parse(data.content)}
      </div>
    </article>
  );
